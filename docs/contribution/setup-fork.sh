...
# upstream   https://github.com/pedro-pereira-dev/ProxmoxVE.git (fetch)
# upstream   https://github.com/pedro-pereira-dev/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/pedro-pereira-dev/ProxmoxVE"
echo ""
