...
source <(curl -fsSL https://raw.githubusercontent.com/pedro-pereira-dev/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/pedro-pereira-dev/ProxmoxVE/main/ct/${service}.sh)
